...
int main(int argc, char* argv[]) {
    ...
    string_tools::get_xparam_from_command_line(
            start_params, std::string("/tests_folder"), tests_data_path);
    ...
    } else if (string_tools::have_in_command_line(
                       start_params, std::string("/run_portable_storage_test"))) {
