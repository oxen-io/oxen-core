...
posted to #dev-general on discord).
...
The "Kegcoin Maintainer Team" is defined in this document as the following users:
- LeoCornelius
- Tobias (ThedevMinerTv)
- Lacroy
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to Kegcoin's code or Kegcoin's dependency code or Kegcoin's potential/future dependency code or research which successfully implements Kegcoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Kegcoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Kegcoin Maintainer Team.
