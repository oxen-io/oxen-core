...
* If you would like a specific [version/tag](https://github.com/loki-project/loki/tags), do a git checkout for that version. eg. 'v0.2.0'. If you dont care about the version and just want binaries from master, skip this step:
