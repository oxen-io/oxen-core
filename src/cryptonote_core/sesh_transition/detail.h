...
/// Returns the mapping of OXEN -> SESH addresses for the given network type.
const std::unordered_map<std::string_view, eth::address>& addresses(network_type net);

/// Returns the OXEN -> SESH conversion ratio to apply to conversion-registered wallets at the
...
/// Returns SESH SN contributor transition bonus amounts (from the SN bonus program) as a map of eth
